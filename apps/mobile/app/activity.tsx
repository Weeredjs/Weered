...
import type {
  ActivityFeedItem as FeedItem,
  ActivityFeedResponse as FeedResponse,
} from "@weered/shared";
...
const NOTORIETY_VISUALS: Record<string, Visual> = {
  DAILY_ACTIVE: {
    ...
    describe: () => "Logged in today",
  },
  CHAT_MESSAGE: {
    icon: "chatbubble",
    color: "#a78bfa",
    label: "Posted a message",
    describe: () => "Spoke up in a room",
  },
  ROOM_JOINED: {
    icon: "log-in",
    color: "#60a5fa",
    label: "Joined a room",
    describe: () => "Stepped into a room",
  },
  VOICE_JOINED: {
    icon: "mic",
    color: "#06b6d4",
    label: "Joined voice",
    describe: () => "Hopped into voice chat",
  },
  BIO_COMPLETE: {
    icon: "person-circle",
    color: "#f5b700",
    label: "Bio completed",
    describe: () => "Filled out your profile bio",
  },
  AVATAR_SET: {
    icon: "image",
    color: "#f5b700",
    label: "Avatar updated",
    describe: () => "Set a custom avatar",
  },
  FIRST_ROOM_HOSTED: {
    icon: "home",
    color: "#f5b700",
    label: "First room hosted",
    describe: () => "Created your very first room",
  },
  ROOM_25_USERS: {
    icon: "people",
    color: "#f97316",
    label: "Hot room",
    describe: () => "Your room hit 25 members",
  },
  CHALLENGE_COMPLETED: {
    icon: "ribbon",
    color: "#f5b700",
    label: "Challenge cleared",
    describe: () => "Completed a challenge",
  },
  FIRST_CHALLENGE: {
    icon: "trophy",
    color: "#f5b700",
    label: "First challenge",
    describe: () => "Cleared your first challenge ever",
  },
  CREW_CREATED: {
    icon: "shield",
    color: "#ef4444",
    label: "Crew founded",
    describe: () => "Started your own crew",
  },
  CREW_JOINED: {
    icon: "people-circle",
    color: "#a78bfa",
    label: "Joined a crew",
    describe: () => "Linked up with a crew",
  },
  FRIEND_ADDED: {
    icon: "person-add",
    color: "#06b6d4",
    label: "New friend",
    describe: () => "Added a friend",
  },
  LOBBY_CREATED: {
    icon: "globe",
    color: "#5800E5",
    label: "Lobby created",
    describe: () => "Spun up a new lobby",
  },
  BUNGIE_LINKED: {
    icon: "game-controller",
    color: "#f97316",
    label: "Bungie linked",
    describe: () => "Connected your Destiny 2 profile",
  },
  SUBREDDIT_LINKED: {
    icon: "link",
    color: "#f97316",
    label: "Subreddit linked",
    describe: () => "Connected a subreddit",
  },
  FIRST_FAKEOUT_TRADE: {
    icon: "trending-up",
    color: "#22c55e",
    label: "First trade",
    describe: () => "Made your first FakeOut trade",
  },
  FAKEOUT_TRADE: {
    icon: "swap-horizontal",
    color: "#a78bfa",
    label: "FakeOut trade",
    describe: () => "Closed a FakeOut position",
  },
  FAKEOUT_PROFIT: {
    icon: "cash",
    color: "#22c55e",
    label: "FakeOut profit",
    describe: () => "Closed a profitable trade",
  },
};
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={{ paddingHorizontal: 32, paddingVertical: 64, alignItems: "center" }}>
              ...
              <Text style={{ color: "rgba(203,213,225,0.6)", fontSize: 13, marginTop: 12 }}>
    ...
    >
      ...
      <View style={{ flex: 1, minWidth: 0 }}>
        ...
        {subtitle && (
          <Text
            numberOfLines={2}
            style={{ color: "rgba(203,213,225,0.65)", fontSize: 11, marginTop: 2 }}
          >
            {subtitle}
          </Text>
        )}
