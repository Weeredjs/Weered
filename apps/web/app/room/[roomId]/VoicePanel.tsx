...
export default function VoicePanel({ roomId }: { roomId: string }) {
  ...
  const card: React.CSSProperties = { border: "1px solid #eee", borderRadius: 14, padding: 12, background: "white" };
  const btn: React.CSSProperties = { border: "1px solid #ddd", borderRadius: 10, padding: "6px 10px", background: "#fff", cursor: "pointer", fontSize: 13 };
  const pill: React.CSSProperties = { border: "1px solid #eee", borderRadius: 999, padding: "2px 8px", fontSize: 12, background: "#fafafa" };
