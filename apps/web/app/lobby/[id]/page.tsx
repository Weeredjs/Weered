            ...
            <div style={{ flex: 1, minHeight: 0, overflow: "auto", display: "flex", flexDirection: "column" }}>
              {view === "modules" && hasModules ? (
                lobbyInfo?.moduleType === "MARATHON" ? (
                  ...
                  /* slice-B-anchor: HD2 squad finder + stratagems. Slice A may replace this with a unified HelldiversModulesPanel. */
                  <HelldiversSliceBPanel lobbyId={lobbyId} accentColor={accent} currentUserId={me?.id} style={{ flex: 1, minHeight: 0 }} />
                ) : (
