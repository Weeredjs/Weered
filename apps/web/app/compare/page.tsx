  ...
  return (
    <main style={{
      ...
      <header style={{ marginBottom: 28 }}>
        <p style={{ fontSize: 12, opacity: 0.6, textTransform: "uppercase", letterSpacing: 1, marginBottom: 4 }}>Comparisons</p>
      ...
      <footer style={{
        ...
        <p style={{ marginBottom: 8 }}>
          Don't see a platform you're comparing? Email us at <a href="mailto:james@weered.ca" style={{ color: "#7c9dff" }}>james@weered.ca</a>.
        </p>
