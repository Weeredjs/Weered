        ...
        <div className={`legal-inner ${visible ? "visible" : ""}`}>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              Weered (<strong>weered.ca</strong>) is operated by Weered Technologies, based in Nova
              Scotia, Canada. This policy explains how we collect, use, disclose, and safeguard your
              information when you use our platform. We comply with the{" "}
              ...
              <table className="legal-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Email address, username, password (hashed)</td>
                  ...
                  <tr>
                    ...
                    <td>Display name, avatar selection, bio</td>
                    <td>Community identity and personalization</td>
                  </tr>
                  <tr>
                    <td>
                      <strong>Usage Data</strong>
                    </td>
                    <td>Lobbies visited, rooms joined, feature interactions</td>
                  ...
                  <tr>
                    ...
                    <td>Text messages sent in rooms and lobby chat</td>
                    <td>Delivery of the messaging service</td>
                  </tr>
                  <tr>
                    <td>
                      <strong>Linked Accounts</strong>
                    </td>
                    <td>Bungie, Riot Games, or other third-party OAuth tokens</td>
                    <td>Game integrations (guardian lookup, summoner stats, etc.)</td>
                  </tr>
                  <tr>
                    <td>
                      <strong>Payment Data</strong>
                    </td>
                    <td>Processed by Stripe; we do not store card numbers</td>
                  ...
                  <tr>
                    ...
                    <td>Security, fraud prevention, and analytics</td>
                  </tr>
                  <tr>
                    <td>
                      <strong>Push Tokens</strong>
                    </td>
                    <td>Web push subscription endpoints</td>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              <ul>
                <li>
                  <strong>We do not record video or audio</strong> from video chat or voice rooms.
                  Video and audio streams are transmitted in real-time via WebRTC and are not stored
                  on our servers.
                </li>
                <li>
                  <strong>We do not record screen shares.</strong> Screen sharing sessions are
                  peer-to-peer and are not captured or retained.
                </li>
                <li>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              ...
              <ul>
                <li>
                  <strong>Bungie / Destiny 2</strong>: OAuth account linking for guardian stats,
                  inventory, and Xur data
                </li>
                <li>
                  <strong>Riot Games</strong>: Riot Sign-On for League of Legends summoner data
                </li>
                <li>
                  <strong>Twitch</strong>: Stream data and embedded players
                </li>
                <li>
                  <strong>Stripe</strong>: Payment processing (PCI-DSS compliant; we never see your
                  full card number)
                </li>
                <li>
                  <strong>LiveKit</strong>: Real-time video, voice, and screen sharing
                  infrastructure
                </li>
                <li>
                  <strong>Web Push (VAPID)</strong>: Browser push notification delivery
                </li>
              </ul>
              When you link a third-party account, we store only the OAuth tokens necessary to
              provide the integration. You can unlink these accounts at any time.
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              Your data is stored on servers located in North America. We use industry-standard
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              We retain your account data for as long as your account is active. Chat messages are
              retained for the operational life of the room or lobby. If you delete your account, we
              will delete your personal data within 30 days, except where we are required to retain
              it by law or for legitimate business purposes (e.g., fraud prevention records).
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              Weered uses <strong>localStorage</strong> to store your authentication token and user
              preferences. We do not use third-party tracking cookies. We do not run third-party
              advertising scripts. We may use minimal analytics to understand platform usage in
              aggregate.
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              Weered surfaces publicly-available metadata from third-party game services to power
              features like the mod catalog, live server browser, stream listings, and live player
              counts. We:
              <ul>
                <li>
                  <strong>Cache metadata only.</strong> For mods, we cache the name, author,
                  summary, thumbnail URL, endorsement count, and download count, sourced from the
                  public Nexus Mods API. We do <strong>not</strong> rehost mod files. Every install
                  link points to the mod's original Nexus page; downloads happen there, not here.
                </li>
                <li>
                  <strong>Do not collect Nexus credentials.</strong> Reading the public catalog
                  never requires a Nexus account or API key. We do not ask users for, store, or
                  proxy any third-party API keys.
                </li>
                <li>
                  <strong>Honour author opt-out.</strong> If you are a mod author and prefer your
                  work not appear in our catalog, email <strong>support@weered.ca</strong> with the
                  mod name. We will hide it from the catalog within one business day. The hide is
                  persistent: even if our poller re-fetches the public Nexus listing, the exclusion
                  stays in effect.
                </li>
                <li>
                  <strong>Other public game data sources we cache the same way:</strong> Steam (live
                  player counts, public server browser), Twitch (live streams for a given game),
                  Bungie (Destiny 2 public profiles, opt-in linked), Riot (League of Legends
                  summoner stats, opt-in linked), and similar first-party public APIs. None of these
                  require us to store credentials beyond what the user explicitly links.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              ...
              <ul>
                ...
                <li>
                  <strong>Withdraw consent</strong> for data processing (this may limit your ability
                  to use the platform)
                </li>
                <li>
                  <strong>Unlink</strong> third-party accounts at any time
                </li>
              </ul>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              Weered is not intended for children under 13. We do not knowingly collect personal
              information from children under 13. If we learn we have collected such information, we
              will delete it promptly. If you believe a child under 13 has provided us with personal
              information, please contact us at <strong>privacy@weered.ca</strong>.
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              ...
              changes through the platform or by email. Your continued use of Weered after changes
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              Privacy questions or data requests: <strong>privacy@weered.ca</strong>
              <br />
