...
export default function HunterDossierView({
  userId,
  initial,
}: {
  userId: string;
      ...
      <div style={{ maxWidth: 820, margin: "0 auto" }}>
        ...
        {d && (
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <div
              style={{ textAlign: "center", paddingTop: 14, borderTop: `1px solid ${PAL.brass}20` }}
            >
              <Link
                href="/lobby/windrose"
                style={{
    ...
    <div
      style={{
        ...
        background: highlight
          ? `linear-gradient(180deg, ${PAL.stormFoam} 0%, ${PAL.stormDeep} 100%)`
          : `${PAL.ink}40`,
      }}
    >
      <div
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
        {rows.map((r) => (
          ...
          >
            <span style={{ color: r.iconColor, flexShrink: 0, width: 14, textAlign: "center" }}>
              {r.icon}
            </span>
            <span
              style={{
