...
const faqLd = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Is Weered affiliated with GGG?", acceptedAnswer: { "@type": "Answer", text: "No. Weered is an unofficial community hub for Path of Exile. We are not affiliated with or endorsed by Grinding Gear Games. PoE, Path of Exile, and related trademarks are property of Grinding Gear Games." }},
    { "@type": "Question", name: "What does the PoE lobby actually do?", acceptedAnswer: { "@type": "Answer", text: "Live economy data via poe.ninja for the current league, ladder leaderboards by class, Twitch chess-style stream directory for PoE streamers, build inspector (pending GGG OAuth approval), crew finder for grouping, and rooms for voice/chat/screen-share while you map together. Free to use." }},
    { "@type": "Question", name: "When does the build inspector go live?", acceptedAnswer: { "@type": "Answer", text: "Build inspector requires GGG's official OAuth access, which Weered applied for on April 16, 2026. GGG's OAuth process can take weeks to months. The live economy, ladder, and streams pages already work today via public data sources (poe.ninja, GGG public ladder API)." }},
    { "@type": "Question", name: "Is it free?", acceptedAnswer: { "@type": "Answer", text: "Yes. The PoE lobby, voice rooms, ladder, economy, and crew tools are all free. Premium tiers exist for cosmetics across the platform starting at $4 / month but the PoE-specific tools are free." }},
  ],
};
        ...
        <section className="mkt-hero">
          <div className="mkt-wrap">
            ...
            <div className="mkt-cta-row">
              ...
              <Link href="/lobby/path-of-exile#ladder" className="mkt-cta-secondary">View the ladder</Link>
            </div>
          </div>
        </section>
          ...
          <div className="mkt-wrap">
            ...
            <div className="mkt-grid-3">
              ...
              <div className="mkt-card">
                ...
                <p>Top of the current league ladder, filterable by class. Pulled from GGG's public ladder API. Updated continuously.</p>
              </div>
              <div className="mkt-card">
              ...
              <div className="mkt-card">
                <h3>Crew finder</h3>
                <p>Looking for a juicing party? Need a 6-stack for delirium farming? Post a flag, find your group, hop in voice.</p>
              </div>
              <div className="mkt-card">
                <h3>Room voice + chat</h3>
                <p>Drop into a room with your crew. Voice, chat, screen-share for build review, paste-in trade window. Real shared workspace while you map.</p>
              </div>
              <div className="mkt-card">
                <h3>Path of Building paste links</h3>
                <p>Share your PoB import code in chat, the lobby renders a preview card. Crew can crit your build without leaving voice.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mkt-section">
          <div className="mkt-wrap">
            ...
            <div className="mkt-callout">
              <strong>OAuth status:</strong> applied 2026-04-16 with james@weered.ca. GGG replied 2026-05-05 asking for the account name; account name (Weeeered#8275) was returned same day. Waiting on credentials. Multi-month waits are normal in GGG's process.
            </div>
          </div>
        </section>
