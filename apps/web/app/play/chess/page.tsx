      ...
      <main className="mkt">
        <section className="mkt-hero">
          <div className="mkt-wrap">
            ...
            <p className="mkt-sub">
              Weered isn't trying to replace Lichess or Chess.com. It's the lobby you sit in while you climb them. Link your accounts, ingest your real rated games, run tournaments verified from the API, and co-watch live games with your crew.
            </p>
            <div className="mkt-cta-row">
              <Link href="/lobby/chess" className="mkt-cta-primary">Open the Chess Lobby</Link>
              <Link href="/lobby/chess#challenges" className="mkt-cta-secondary">See active challenges</Link>
            </div>
          </div>
        </section>
        ...
        <section className="mkt-section">
          <div className="mkt-wrap">
            ...
            <div className="mkt-grid-3">
              ...
              <div className="mkt-card">
                <h3>Challenges</h3>
                <p>Bullet sprints, blitz five-streaks, Sicilian specialist runs, rating-climb objectives. Wins credit automatically from your Lichess and Chess.com games.</p>
              </div>
              <div className="mkt-card">
                <h3>Tournaments</h3>
                <p>Bullet Bash, Blitz Weekend Cup, Weekly Rating Climb, Opening-Themed Cups. Sign up with your linked accounts; results credit from the API. Notoriety and Paper rewards.</p>
              </div>
              <div className="mkt-card">
                <h3>My Chess</h3>
                <p>Your linked accounts, current ratings (bullet / blitz / rapid / classical / puzzle), recent games, and challenge progress. Updated every 5 minutes.</p>
              </div>
              <div className="mkt-card">
                <h3>Game Audit</h3>
              ...
              <div className="mkt-card">
                ...
                <p>Drop Lichess TV, daily puzzle, a specific game URL, a study, or a broadcast on the room stage. Everyone in voice watches the same board. Co-analyse aloud.</p>
              </div>
            </div>
          </div>
        </section>
