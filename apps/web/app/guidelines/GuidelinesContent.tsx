      ...
      <div className="legal-root">
        <div className={`legal-inner ${visible ? "visible" : ""}`}>
          ...
          <div className="legal-intro">
            Weered is built for people who want to hang out around things they care about. These guidelines exist to keep it that way. They apply everywhere on the platform: chat, forums, video rooms, screen shares, and profiles.
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              <ul>
                <li><span className="legal-do">Do:</span> Be a real person. Talk about what you like. Help people out. Have fun.</li>
                <li><span className="legal-dont">Don't:</span> Harass people. Share illegal content. Spam. Be a creep on video. Ruin it for everyone.</li>
              </ul>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              <ul>
                <li><strong>No harassment.</strong> Targeted insults, threats, doxing, stalking, or persistent unwanted contact will result in an immediate ban.</li>
                <li><strong>No hate speech.</strong> Slurs, bigotry, or content that attacks people based on race, ethnicity, religion, gender, sexual orientation, disability, or national origin are not tolerated.</li>
                <li><strong>No impersonation.</strong> Don't pretend to be someone else, including other users, public figures, or Weered staff.</li>
                <li><strong>Trash talk is fine.</strong> This is a gaming platform. Competitive banter is expected. There's a line between trash talk and abuse. You know where it is.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              Video rooms and screen sharing are real-time features. What you share is seen by everyone in the room, live. There is no undo.
              <ul>
                <li><strong>No NSFW content.</strong> Do not share nudity, sexual content, or graphic violence on camera or via screen share.</li>
                <li><strong>No copyrighted streams.</strong> Do not screen share movies, TV shows, PPV events, or other copyrighted content you don't have rights to distribute. Watching a YouTube video together is fine. Streaming a Netflix movie is not.</li>
                <li><strong>No illegal content.</strong> This should go without saying. Content depicting child exploitation, terrorism, or illegal activities will result in an immediate permanent ban and may be reported to law enforcement.</li>
                <li><strong>Consent matters.</strong> Don't record other people's video or screen shares without their knowledge. Don't share someone else's personal information revealed on camera.</li>
                <li><strong>Room owners set the tone.</strong> Lobby owners and room moderators can set additional rules for their spaces. Respect them.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              <ul>
                <li><strong>No spam.</strong> Don't flood chat, post repetitive content, or promote products/services without permission.</li>
                <li><strong>No phishing or malware.</strong> Don't share deceptive links, scam attempts, or malicious downloads.</li>
                <li><strong>Stay on topic.</strong> Each lobby has a community and culture. Respect it. The Destiny lobby is for Destiny. The NHL lobby is for hockey. General chat goes in The Lobby.</li>
                <li><strong>Forum moderation is local.</strong> Lobby owners and moderators manage their own forums. Their rules apply in addition to these guidelines.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              If you see something that violates these guidelines, report it. You can report users, messages, and rooms through the platform. For urgent issues involving illegal content or safety threats, email <strong>safety@weered.ca</strong> immediately.
            </div>
          </div>
          ...
          <div className="legal-section">
            ...
            <div className="legal-text">
              Weered is a place to hang out with people who like the same things you do. We built it because we wanted it to exist. Help us keep it worth using.
            </div>
          </div>
