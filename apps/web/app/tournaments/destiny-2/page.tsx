...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    siteName: "Weered",
    images: [{ url: "https://weered.ca/brand/lobbies/destiny2-og-v1.png", width: 1200, height: 630 }],
  },
  twitter: {
      ...
      <main className="mkt">
        <section className="mkt-hero">
          <div className="mkt-wrap">
            ...
            <h1 className="mkt-h1">
              Tournaments that <span className="accent">verify themselves</span> from the Bungie API.
            </h1>
            <p className="mkt-sub">
              Run Pantheon 2.0 races, Trials brackets, raid speedruns, and Custom Ops challenges. Results flow in from PGCRs the moment your fireteam clears the activity. No screenshots, no manual scoring, no honour system.
            </p>
            <div className="mkt-cta-row">
              <Link href="/lobby/destiny2" className="mkt-cta-primary">Open the Destiny 2 lobby</Link>
              <Link href="/lobby/destiny2#tournaments" className="mkt-cta-secondary">See live tournaments</Link>
            </div>
          </div>
        </section>
        ...
        <section className="mkt-section">
          <div className="mkt-wrap">
            ...
            <p className="mkt-p">
              Every Bungie-API-supported activity is recognised: raids, dungeons, Nightfalls, Trials, Crucible, Onslaught, Pantheon, and the new Custom Ops with player-selected Skull modifiers. The tournament you create can be activity-locked (a specific encounter, like K1 Logistics on Master), modifier-locked (Match Game + Arc Surge required), or wide-open (any GM strike clear counts).
            </p>
            <p className="mkt-p">
              <strong>The challenge engine handles the hard cases.</strong> Skull modifier identifier hashes are tracked separately from legacy Activity Modifier hashes, so Custom Ops challenges credit correctly. The 51-marker tier fallback solves Bungie's inconsistent difficulty-tier integer. Activity-hash filters collapse all variant Master / Ultimate forms of a strike into one selectable option. The system that runs Weered's Impossible Tournament is the same one you'd use for your event.
            </p>
          </div>
        </section>
          ...
          <div className="mkt-wrap">
            ...
            <div className="mkt-grid-3">
              <div className="mkt-card">
                <h3>Speed run</h3>
                <p>Fastest fireteam clear of a target activity wins. PGCR completion-time is the source of truth.</p>
              </div>
              <div className="mkt-card">
                <h3>Bracket elimination</h3>
                <p>Single-elimination or double-elimination, seeded by sign-up order or rating. Match results auto-confirm from PGCR.</p>
              </div>
              <div className="mkt-card">
                <h3>Challenge race</h3>
                <p>First team to complete a list of objectives (clear X, with Y modifier, on Z difficulty) wins the round.</p>
              </div>
              <div className="mkt-card">
                <h3>Custom Ops league</h3>
                <p>Player-chosen Skull modifier combos. Higher difficulty = more Notoriety. Leaderboard updates as PGCRs land.</p>
              </div>
              <div className="mkt-card">
                <h3>Trials weekend cup</h3>
                <p>Card-based scoring. 7-0 flawless = top prize. Auto-reads from Bungie's Crucible API.</p>
              </div>
              <div className="mkt-card">
                <h3>Pantheon ladder</h3>
                <p>Encounter-by-encounter time tracking. Compare your fireteam against the global ladder, in your lobby.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mkt-section">
          <div className="mkt-wrap">
            ...
            <ul className="mkt-bullet-list">
              <li><strong>Flair.</strong> Custom champion flair that persists on a player's name across the platform. Earned, not bought.</li>
              <li><strong>Notoriety.</strong> Platform-wide XP. Stacks toward platform tiers and visibility.</li>
              <li><strong>Paper.</strong> In-platform currency, spendable on store items, tournament buy-ins, and crew goods.</li>
              <li><strong>Hall of Fame entries.</strong> Your fireteam's PGCR-verified clear sits on the public leaderboard with the receipt attached.</li>
              <li><strong>Custom flair contests.</strong> The community designs the prize. Voting is public. Winners get their art applied as the real flair grant.</li>
            </ul>
          </div>
        </section>
