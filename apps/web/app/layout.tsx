      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{if(localStorage.getItem('weered_token')){localStorage.removeItem('weered_token');}}catch(e){}if(typeof window==='undefined'||window.__wfp)return;window.__wfp=1;try{if(/^(office|meet)\\.eastcoastemployeebenefits\\.com$/.test(location.hostname)){var _de=document.documentElement;_de.setAttribute('data-pro-host','1');_de.setAttribute('data-weered-theme','press');try{localStorage.setItem('weered_theme_v2','press');}catch(e2){}_de.style.background='#1a1a1c';}}catch(e){}var _wl=/(^|\\.)weered\\.ca$/.test(location.hostname)||location.hostname==='localhost'||location.hostname==='127.0.0.1';var _f=window.fetch;window.fetch=function(i,o){o=o||{};var u=typeof i==='string'?i:(i&&i.url)||'';if(u.indexOf('api.weered.ca')!==-1){if(!_wl){var p=u.replace(/^https?:\\/\\/api\\.weered\\.ca/,'/api');if(typeof i==='string'){i=p;}else{try{i=new Request(p,i);}catch(e){}}}o.credentials='include';try{var h=new Headers(o.headers||{});h.delete('authorization');h.set('x-client','web');o.headers=h;}catch(e){}}return _f.call(this,i,o);};})();`,
          }}
        />
      </head>
      <body>
