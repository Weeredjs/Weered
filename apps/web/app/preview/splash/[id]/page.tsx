    ...
    <main style={{ position: "fixed", inset: 0, background: "#03050a" }}>
      {preset ? (
        ...
        <div style={{
          ...
          color: "#a89775", fontFamily: "Georgia, serif", padding: 40, textAlign: "center",
        }}>
          <div>
            <div style={{ fontSize: 14, letterSpacing: 3, textTransform: "uppercase", opacity: 0.55, marginBottom: 8 }}>No preset</div>
            <div style={{ fontSize: 22, marginBottom: 14 }}>Unknown lobby id: <code style={{ color: "#e8c48a" }}>{id}</code></div>
            <div style={{ fontSize: 13, opacity: 0.7 }}>
              Try <a href="/preview/splash/windrose" style={{ color: "#e8c48a" }}>/preview/splash/windrose</a>
              {" · "}
              <a href="/preview/splash/destiny2" style={{ color: "#f58220" }}>/preview/splash/destiny2</a>
            </div>
          </div>
        </div>
      )}
