...
function renderMessage(msg: string): React.ReactNode[] {
  ...
  while ((m = re.exec(msg)) !== null) {
    ...
    parts.push(
      <em key={key++} style={{ color: "#FFD700", fontStyle: "italic", fontWeight: 600 }}>
        {m[1]}
      </em>,
    );
...
export default function HelldiversDispatchesPanel({
  style,
  limit = 20,
}: {
  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        <div
          style={{ padding: 16, textAlign: "center", color: "rgba(255,255,255,.4)", fontSize: 12 }}
        >
