...
const CREATE_LABELS: Record<
  string,
  { btn: string; title: string; placeholder: string; icon: string }
> = {
  DND: {
    btn: "Open a Table",
    title: "Open a Table",
    placeholder: "e.g. Curse of Strahd — Session 4",
    icon: "🎲",
  },
  POKER: {
    btn: "Start a Table",
    title: "Start a Table",
    placeholder: "e.g. $500 Buy-In NLH",
    icon: "♠️",
  },
  STUDY: {
    btn: "Open a Room",
    title: "Create Study Room",
    placeholder: "e.g. Organic Chem Finals Grind",
    icon: "📚",
  },
};
const DEFAULT_LABEL = {
...
const MODULE_OPTIONS_BY_TYPE: Record<string, { value: string; label: string }[]> = {
  ...
  TRADING: [
    { value: "voice", label: "Voice" },
    { value: "fakeout", label: "FakeOut Trading" },
  ...
  STUDY: [
    { value: "voice", label: "Voice" },
    { value: "study", label: "Focus Timer" },
    { value: "video", label: "Video" },
  ],
  DND: [
    { value: "voice", label: "Voice" },
    { value: "dnd", label: "D&D Tools" },
    { value: "youtube", label: "YouTube" },
    { value: "browser", label: "Browser" },
  ],
  HEADQUARTERS: [
    { value: "voice", label: "Voice" },
    { value: "hq", label: "HQ Dashboard" },
    { value: "video", label: "Video" },
    { value: "screen", label: "Screen Share" },
  ],
  NEWS: [
  ...
  if (rooms.length === 0) {
    return (
      ...
      >
        ...
        <div style={{ fontSize: 14, fontWeight: 800, color: "rgba(255,255,255,.55)", zIndex: 2 }}>
          No rooms open here.
        </div>
        <div style={{ fontSize: 12, color: "rgba(255,255,255,.35)", zIndex: 2, marginTop: -6 }}>
        ...
        {showCreate && (
          ...
          >
            ...
            <div>
              ...
              >
                {showAdvanced ? "▾" : "▸"} disable specific modules
                {disabledModules.size > 0 ? ` (${disabledModules.size})` : ""}
              </button>
              {showAdvanced && (
                <div
                  style={{
    ...
    <div style={{ flex: 1, overflowY: "auto", position: "relative", ...style }}>
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(ellipse at center, transparent 20%, rgba(0,0,0,.7) 100%)",
            }}
          />
          <div
            style={{
      ...
      <div style={{ position: "relative", zIndex: 1, padding: "20px 22px 32px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
          ...
          />
          <span
            className="weered-rooms-section-label"
            style={{
              fontSize: 11,
              fontWeight: 800,
              letterSpacing: "0.1em",
          ...
          <span
            className="weered-rooms-section-count"
            style={{
              fontSize: 10,
              fontFamily: "monospace",
              fontWeight: 700,
          ...
          <div
            className="weered-rooms-section-divider"
          ...
          <button
            ...
            style={{
              ...
              background: showCreate ? `${accent}22` : `${accent}0c`,
            ...
            onMouseEnter={(e) => {
              if (!showCreate) {
                ...
                e.currentTarget.style.color = "rgba(243,244,246,.8)";
              }
            }}
            onMouseLeave={(e) => {
              if (!showCreate) {
                e.currentTarget.style.background = `${accent}0c`;
                e.currentTarget.style.color = "rgba(243,244,246,.55)";
              }
            }}
          >
        ...
        {showCreate && (
          <div
            className="weered-rooms-create-form"
            style={{
              marginBottom: 18,
              padding: "14px 16px",
              borderRadius: 12,
          ...
          >
            <div style={{ fontSize: 12, fontWeight: 700, color: "rgba(243,244,246,.8)" }}>
              {labels.title}
            </div>
            <div style={{ display: "flex", gap: 8 }}>
              <input
                ...
                <div style={{ position: "relative", zIndex: 1, padding: "16px 18px 18px" }}>
                  ...
                  >
                    <div
                      style={{
                        ...
                        background: customIcon
                          ? "rgba(0,0,0,.25)"
                          : `linear-gradient(135deg, ${cardColor}1a, ${cardColor}0a)`,
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div
                        className="weered-room-card-name"
                        style={{
                          fontWeight: 800,
                          fontSize: 15,
                          lineHeight: 1.25,
                      ...
                      <div
                        className="weered-room-subtitle"
                        style={{
                          fontSize: 11,
