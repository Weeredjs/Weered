            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, marginBottom: 14 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div style={{ fontSize: 12, color: "rgba(255,255,255,.7)" }}>
                  ...
                  <strong style={{ color: "rgba(255,255,255,.9)" }}>Share</strong> button in Safari
                </div>
              </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <div style={{ fontSize: 12, color: "rgba(255,255,255,.7)" }}>
                  Scroll down, tap{" "}
                  <strong style={{ color: "rgba(255,255,255,.9)" }}>Add to Home Screen</strong>
                </div>
              </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div
          style={{ fontSize: 13, fontWeight: 700, color: "rgba(243,244,246,.92)", lineHeight: 1.3 }}
        >
          Stay in the loop.
        </div>
        <div
          style={{ fontSize: 11, color: "rgba(148,163,184,.65)", marginTop: 2, lineHeight: 1.4 }}
        >
      ...
      <button
        ...
        onMouseEnter={(e) => {
          ...
          (e.currentTarget as HTMLElement).style.color = "rgba(243,244,246,.8)";
        }}
        onMouseLeave={(e) => {
