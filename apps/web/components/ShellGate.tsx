...
const NO_SHELL_ROUTES = ["/", "/login", "/register", "/staff", "/about", "/premium", "/contact", "/mods", "/apply", "/desktop", "/why-not-discord", "/alternatives", "/tournaments", "/play", "/compare", "/lfg", "/explore", "/overlay", "/terms", "/privacy", "/guidelines", "/forgot-password", "/reset-password", "/verify-email", "/media-policy", "/safety", "/features"];
