    ...
    <Backdrop onClose={onClose}>
      ...
      >
        ...
        >
          ...
          >
            <div
              style={{
                ...
                borderRadius: 999,
                flexShrink: 0,
                background: build.author.avatar
                  ? "rgba(255,255,255,.08)"
                  : build.author.avatarColor || "rgba(201,160,102,.4)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontSize: 12,
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 700, color: "rgba(228,212,176,.95)" }}>
                {build.author.name}
              </div>
          ...
          <div
            style={{ display: "flex", flexWrap: "wrap", gap: 5, marginTop: 10, marginBottom: 14 }}
          >
          ...
          <div style={{ display: "flex", gap: 6, marginBottom: 14 }}>
            ...
            {!isAuthor && (
              <SmallBtn onClick={() => setShowReport(true)} danger>
                Report
              </SmallBtn>
            )}
            {isAuthor && (
              <SmallBtn onClick={() => setConfirmDelete(true)} danger>
                Delete
              </SmallBtn>
            )}
          </div>
            ...
            <div style={{ display: "flex", gap: 6, marginBottom: 12 }}>
              ...
              <button
                ...
                style={{
                  ...
                  color:
                    commentBody.trim() && !commentSubmitting ? "#e8c48a" : "rgba(228,212,176,.4)",
                  borderRadius: 3,
                  fontSize: 11,
                  fontWeight: 700,
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {comments.length === 0 ? (
              <div style={{ fontSize: 11, opacity: 0.45, padding: "8px 0" }}>
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: 999,
                      flexShrink: 0,
                      background: c.user?.avatar
                        ? "rgba(255,255,255,.08)"
                        : c.user?.avatarColor || "rgba(201,160,102,.35)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: 10,
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      <span
                        style={{ fontSize: 11, fontWeight: 700, color: "rgba(228,212,176,.85)" }}
                      >
                        {c.user?.name || "—"}
                      </span>
      ...
      {showReport && <ReportDialog slug={slug} onClose={() => setShowReport(false)} />}
        ...
        {done ? (
          <div style={{ textAlign: "center", padding: 20 }}>
            ...
            <div style={{ fontSize: 12, opacity: 0.65 }}>
              The crew thanks you. Mods will review.
            </div>
          </div>
        ) : (
          <>
            <div style={{ fontSize: 16, fontWeight: 800, marginBottom: 4, color: "#e8c48a" }}>
              Report this build
            </div>
            <div style={{ fontSize: 11, opacity: 0.6, marginBottom: 12 }}>
              Pick a reason. Add a note if it helps.
            </div>
...
function ConfirmDialog({
  ...
  return (
    <Backdrop onClose={onCancel}>
      ...
      >
        <div style={{ fontSize: 16, fontWeight: 800, color: "#e8c48a", marginBottom: 8 }}>
          {title}
        </div>
