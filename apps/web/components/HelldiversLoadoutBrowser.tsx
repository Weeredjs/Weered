...
export default function HelldiversLoadoutBrowser({ lobbyAccent = "#FFD700", onCreate }: Props) {
  ...
  async function fetchList() {
    ...
    params.set("limit", "60");
    try {
      const res = await fetch(`${API}/helldivers/loadouts?${params.toString()}`, {
        headers: { ...authHeaders() },
      });
      ...
      >
        ...
        <button
          ...
          style={{
            padding: "8px 14px",
            borderRadius: 4,
            border: `2px solid ${lobbyAccent}`,
            background: lobbyAccent,
            color: "#000",
            fontWeight: 800,
            letterSpacing: 1,
            cursor: "pointer",
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        (e.currentTarget as HTMLElement).style.boxShadow = `0 6px 20px ${meta.color}55`;
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <div style={{ padding: 12 }}>
        ...
        <div style={{ marginTop: 8, fontSize: 11.5, color: "#bbb", lineHeight: 1.4 }}>
          ...
          <div style={{ color: "#888" }}>
            + {loadout.secondary} · {loadout.throwable}
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ marginTop: 14 }}>
            <Section accent={meta.color} title="STRATAGEMS">
              <ol
                style={{ margin: 0, paddingLeft: 18, color: "#fff", fontSize: 13, lineHeight: 1.7 }}
              >
                <li>{l.stratagem1}</li>
                <li>{l.stratagem2}</li>
                <li>{l.stratagem3}</li>
          ...
          >
            ...
            <div
              style={{
                fontSize: 32,
                fontWeight: 900,
                color: score > 0 ? "#10b981" : score < 0 ? "#f87171" : "#fff",
                lineHeight: 1,
              }}
            >
              {score >= 0 ? "+" : ""}
            ...
            <div style={{ fontSize: 11, color: "#666", marginTop: 4 }}>
              {l.upvotes}↑ / {l.downvotes}↓ · {l.views} views
            </div>
          </div>
          <button
            disabled={voting}
