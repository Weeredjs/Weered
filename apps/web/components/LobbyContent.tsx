...
const FEED_DOMAINS = new Set([
  ...
  "theguardian.com", "spotify.com", "mmamania.com", "youtube.com",
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0 }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, position: "relative" }}>
          ...
          <input
            ...
            style={{
              ...
              borderRadius: 8, color: "rgba(203,213,225,0.8)",
        ...
        <div style={{
          ...
          fontSize: 9, fontWeight: 700, color: "rgba(167,139,250,0.7)",
          ...
          <>
            {loading && (
              <div style={{
                ...
                <div style={{ fontSize: 13, color: "rgba(148,163,184,0.4)", letterSpacing: "0.06em" }}>
                  Loading {lobbyId}...
                </div>
              </div>
            )}
            <iframe
              ref={iframeRef}
              src={iframeUrl}
              style={{ width: "100%", height: "100%", border: "none", display: "block", colorScheme: "normal" }}
...
function BlockedState({ domain, url, onOpenExternal }: { domain: string; url: string; onOpenExternal: () => void }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: 12, color: "rgba(148,163,184,0.4)", textAlign: "center", maxWidth: 320, lineHeight: 1.7 }}>
        This site uses security headers that prevent it from being displayed inside Weered.
      ...
      <button
        ...
        style={{
          ...
          color: "rgba(167,139,250,0.9)", fontSize: 13, fontWeight: 700, cursor: "pointer",
        }}
      >
