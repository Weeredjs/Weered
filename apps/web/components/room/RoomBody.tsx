...
export default function RoomBody({
  ...
  return (
    <div
      className="mt-3 grid gap-3 lg:grid-cols-[1fr_360px]"
      style={{ height: "calc(100vh - 200px)", minHeight: 0 }}
    >
      <div
      ...
      <div className="rounded-xl border border-white/10 bg-black/20 p-3 hidden lg:block sticky top-24 max-h-[calc(100vh-120px)] overflow-auto">
        {right ?? (
          <div className="opacity-70">
            ...
            <div className="text-sm">Placeholder panel for tiles, links, activity feed, etc.</div>
          </div>
        )}
      </div>
    </div>
