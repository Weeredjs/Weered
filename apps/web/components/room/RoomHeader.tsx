          ...
          <div style={{ display: "flex", alignItems: "center", gap: 9, flex: 1, minWidth: 0 }}>
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                ...
                {locked && <span style={{ fontSize: 10, opacity: 0.4, flexShrink: 0 }}>🔒</span>}
              </div>
              {lobbyName && (
                <div
                  style={{
            ...
            {onLeave && (
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.color = "rgba(252,165,165,.85)";
                  e.currentTarget.style.borderColor = "rgba(239,68,68,.28)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "rgba(239,68,68,.05)";
                  e.currentTarget.style.color = "rgba(252,165,165,.45)";
                  e.currentTarget.style.borderColor = "rgba(239,68,68,.12)";
                }}
              >
                Leave
              </button>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    boxShadow: m.active
                      ? `0 0 16px ${accent}20, inset 0 0 12px ${accent}08`
                      : "none",
                  }}
                  onMouseEnter={(e) => {
