      ...
      {open ? (
        ...
        >
          <div
            ...
            style={{ width: "min(520px, 96vw)", background: "#fff", borderRadius: 14, padding: 14, border: "1px solid var(--weered-border)" }}
          >
            ...
            <div style={{ marginTop: 10, display: "grid", gap: 8 }}>
              <input
                ...
                style={{ padding: "10px 12px", borderRadius: 12, border: "1px solid var(--weered-border)" }}
              />
              <input
                value={roomId}
            ...
            <div style={{ marginTop: 12, display: "flex", justifyContent: "flex-end", gap: 8 }}>
              <button
                onClick={() => setOpen(false)}
                style={{ padding: "8px 12px", borderRadius: 10, border: "1px solid var(--weered-border)" }}
              >
                Cancel
              </button>
              <button
