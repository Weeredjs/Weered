            ...
            {view === "menu" ? (
              <>
                <button
                  type="button"
                  role="menuitem"
                  className="weered-logo-menu-item"
                  onClick={goHome}
                >
                  <svg
                    width="14"
                ...
                >
                  ...
                  {hot && (
                    <span className="weered-logo-menu-pill">
                ...
                >
                  ...
                  <span className="weered-logo-menu-label">
                    {isAway ? "Come back" : "Lying low"}
                  </span>
                ...
                <button
                  type="button"
                  role="menuitem"
                  className="weered-logo-menu-item is-danger"
                  onClick={doLogout}
                >
                  <svg
                    width="14"
