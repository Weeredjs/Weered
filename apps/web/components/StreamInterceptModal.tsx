      ...
      >
        ...
        <div style={{ position: "relative", aspectRatio: "16/9", background: "#000", overflow: "hidden" }}>
          {thumb ? (
            ...
            <div style={{ width: "100%", height: "100%", background: `${accent}15`, display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <div style={{ position: "absolute", bottom: 14, left: 14, right: 14 }}>
            ...
            <div style={{ fontSize: 12, color: "rgba(148,163,184,.75)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
              {stream.title}
            </div>
            <div style={{ fontSize: 11, color: "rgba(148,163,184,.55)", marginTop: 4, display: "flex", alignItems: "center", gap: 6 }}>
              {stream.gameName && <span>{stream.gameName}</span>}
              {stream.gameName && <span style={{ opacity: 0.3 }}>·</span>}
              <span style={{ color: "rgba(252,165,165,.8)" }}>{stream.viewerCount.toLocaleString()} viewers</span>
            </div>
          </div>
        </div>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                {meRole && (
                  <span style={{ fontSize: 9, fontWeight: 700, padding: "1px 5px", borderRadius: 4, background: `${accent}20`, border: `1px solid ${accent}40`, color: accent }}>
                    {meRole}
                  </span>
                )}
              </div>
              <div style={{ fontSize: 10, opacity: 0.4, marginTop: 1 }}>choosing where to watch...</div>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 5, flexShrink: 0 }}>
              <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#22c55e", boxShadow: "0 0 4px #22c55e" }} />
              <span style={{ fontSize: 10, color: "rgba(134,239,172,.8)", fontWeight: 600 }}>online</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: "16px 18px 20px" }}>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontWeight: 700, fontSize: 14, color: "rgba(243,244,246,.95)" }}>Watch Here</div>
              <div style={{ fontSize: 11, color: accent, opacity: 0.7, marginTop: 1 }}>Open the stream inline in this lobby</div>
            </div>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontWeight: 700, fontSize: 14, color: "rgba(243,244,246,.95)" }}>Join Live Room</div>
              <div style={{ fontSize: 11, color: accent, opacity: 0.7, marginTop: 1 }}>Watch with others in a dedicated room</div>
            </div>
            <span style={{ fontSize: 18, opacity: 0.4, flexShrink: 0, color: accent }}>→</span>
          </button>
        </div>
