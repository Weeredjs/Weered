  ...
  return (
    <div
      style={{
        ...
        opacity: 0.03,
        background:
          "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(0,229,204,0.15) 2px, rgba(0,229,204,0.15) 4px)",
      }}
    />
  );
}
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      {activeStream && (
        ...
        >
          ...
          >
            <span
              style={{ fontSize: 12, fontWeight: 700, color: M.accent, fontFamily: "monospace" }}
            >
              {activeStream}
            </span>
            <button onClick={() => setActiveStream(null)} style={S.btn}>
              CLOSE
            </button>
          </div>
        </div>
        ...
        {streams.map((s) => (
          <div
            ...
            style={{
              ...
              border:
                activeStream === s.userLogin ? `1px solid ${M.accentMid}` : `1px solid ${M.border}`,
            }}
          >
            {s.thumbnailUrl && (
              <img
      ...
      {streams.length === 0 && (
        ...
        >
          NO LIVE MARATHON FEEDS DETECTED
        </div>
      )}
    ...
    <div>
      ...
      >
        <div style={{ fontSize: 11, opacity: 0.5, fontFamily: "monospace" }}>
          {posts.length} ACTIVE SQUADS
        </div>
        <button style={S.btnAccent} onClick={() => setShowForm(!showForm)}>
          {showForm ? "CANCEL" : "+ DEPLOY BEACON"}
        </button>
      </div>
      {msg && (
        <div style={{ marginBottom: 8, fontSize: 11, color: M.warning, fontFamily: "monospace" }}>
          {msg}
        </div>
      )}
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 8 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <input
                  ...
                  placeholder="Mic required, chill run..."
                />
              </div>
            </div>
            <button
          ...
          return (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {p.description && (
                  <div style={{ fontSize: 10, opacity: 0.4, marginBottom: 3 }}>{p.description}</div>
                )}
                <div
                  style={{
                    display: "flex",
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 4, flexShrink: 0 }}>
                {!isFull && (
                  <button style={S.btnAccent} onClick={() => joinPost(p.id)}>
                    JOIN
                  </button>
                )}
                <button style={S.btn} onClick={() => leavePost(p.id)}>
                  LEAVE
                </button>
              </div>
            </div>
              ...
              {Array.from({ length: 4 }).map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      i < zone.threat
                        ? `0 0 4px ${zone.threat >= 4 ? M.danger : zone.threat >= 3 ? M.warning : M.accent}`
                        : "none",
                  }}
                />
              ))}
              <span style={{ fontSize: 9, opacity: 0.4, fontFamily: "monospace", marginLeft: 4 }}>
                THREAT
              </span>
            </div>
          </div>

          <div style={{ fontSize: 12, lineHeight: 1.6, opacity: 0.7, marginBottom: 14 }}>
            {zone.desc}
          </div>
            ...
            >
              ...
              <div
                style={{
                  fontSize: 12,
                  fontWeight: 700,
                  color: zone.threat >= 4 ? M.ranked : zone.threat >= 3 ? M.warning : M.accent,
                  fontFamily: "monospace",
                }}
              >
                {zone.loot}
...
const RUNNERS = [
  {
    name: "Assassin",
    role: "Flanker",
    desc: "Silent and deadly. Built for aggressive flanking and catching enemies off-guard.",
    color: "#FF4466",
    icon: "🗡",
  },
  {
    name: "Vandal",
    role: "Flanker",
    desc: "Disruptive chaos agent. Excels at breaking enemy formations and creating openings.",
    color: "#FF6644",
    icon: "💥",
  },
  {
    name: "Destroyer",
    role: "Frontline",
    desc: "The wall. Anchors the team with heavy firepower and damage absorption.",
    color: "#4488FF",
    icon: "🛡",
  },
  {
    name: "Recon",
    role: "Intel",
    desc: "Eyes of the team. Long-range intel gathering and precision strikes from distance.",
    color: "#44DDFF",
    icon: "🔭",
  },
  {
    name: "Thief",
    role: "Stealth",
    desc: "In and out. Covert loot specialist who rewards clean, efficient extraction runs.",
    color: "#AA66FF",
    icon: "👻",
  },
  {
    name: "Triage",
    role: "Support",
    desc: "The lifeline. Keeps the crew alive through healing and tactical support.",
    color: "#44FF88",
    icon: "💉",
  },
  {
    name: "Rook",
    role: "Wildcard",
    desc: "The opportunist. Scavenger mode with adaptive playstyle — thrives in chaos.",
    color: "#FFB020",
    icon: "🎲",
  },
];
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      <div style={{ ...S.label, marginBottom: 2 }}>
        7 RUNNER SHELLS — TAU CETI IV DEPLOYMENT ROSTER
      </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <span
                  style={{ fontWeight: 800, fontSize: 13, fontFamily: "monospace", color: r.color }}
                >
                  {r.name.toUpperCase()}
                </span>
                <span
              ...
              {selected === i && (
                <div style={{ fontSize: 11, opacity: 0.6, marginTop: 4, lineHeight: 1.5 }}>
                  {r.desc}
                </div>
              )}
            </div>
...
function MyRunner({ accentColor }: { accentColor?: string }) {
  ...
  return (
    ...
    >
      ...
      >
        Bungie has not yet released a public Marathon API. When they do, this tab will show your
        Runner stats, match history, loadout, ranked progression, and extraction data — all pulled
        live from your linked Bungie account.
      </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div
              ...
              style={{
                ...
                padding: "8px 10px",
                borderRadius: 2,
                background: i === 0 ? "rgba(232,197,71,0.04)" : "transparent",
      ...
      <div style={{ ...S.card, textAlign: "center" }}>
        ...
        <div style={{ fontSize: 10, opacity: 0.3, marginTop: 4 }}>
          Progress resets each season. Cosmetics and Codex carry over.
        </div>
      </div>
    </div>
  );
  ...
  const thumbnail = (
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      <div style={{ ...S.label, display: "flex", alignItems: "center", gap: 8 }}>
        ...
        >
          <span style={{ fontSize: 12, filter: "drop-shadow(0 0 4px rgba(232,197,71,.5))" }}>
            &#9733;
          </span>
          LordTT
        </span>
      ...
      <div style={{ fontSize: 10, opacity: 0.3, fontFamily: "monospace", textAlign: "center" }}>
        Map by <span style={{ color: M.accent, opacity: 1 }}>LordTT</span> — click to open
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 10, opacity: 0.35, fontFamily: "monospace" }}>by LordTT</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <button
            ...
            style={{ ...S.btn, padding: "4px 10px", fontSize: 14, lineHeight: 1 }}
          >
            +
          </button>
          <button
          ...
          <button onClick={resetView} style={{ ...S.btn, padding: "4px 10px", fontSize: 10 }}>
            RESET
          </button>
          <button
