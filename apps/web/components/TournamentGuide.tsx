      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <Panel accent={accent} glow>
          ...
          <div style={{ fontSize: 12, color: "rgba(255,255,255,.85)", lineHeight: 1.5 }}>
            The goals. Do an activity with specific skulls or modifiers.
          </div>
        </Panel>
        ...
        <Panel accent={accent} glow>
          ...
          <div style={{ fontSize: 12, color: "rgba(255,255,255,.85)", lineHeight: 1.5 }}>
            The race. Pool challenges, earn points, climb the board.
          </div>
        </Panel>
      </div>
    ),
  },
  {
    ...
    art: (accent) => (
      <Panel accent={accent}>
        ...
        >
          <span style={{ color: "#86efac", fontWeight: 700 }}>✓ Preview</span> — Complete 1
          Nightfall with Match Game + Arc Surge
        </div>
      </Panel>
    ),
  },
  {
    ...
    art: (accent) => (
      <Panel accent={accent}>
        ...
        <div style={{ fontSize: 9, color: "rgba(255,255,255,.4)", marginBottom: 6 }}>
          CHALLENGES IN POOL
        </div>
    ...
    art: (accent) => (
      <Panel accent={accent}>
        ...
        <div style={{ display: "flex", gap: 16, fontSize: 11, color: "rgba(255,255,255,.55)" }}>
          <span>
            <span style={{ color: accent, fontWeight: 700 }}>Goal</span> 500 pts
          </span>
          <span>
            <span style={{ color: accent, fontWeight: 700 }}>Runs</span> Jun 9 → Jun 12
          </span>
          <span>
            <span style={{ color: accent, fontWeight: 700 }}>Reward</span> Champion banner
          </span>
        </div>
      </Panel>
    ),
        ...
        {[
          ...
          <div
            ...
            style={{
              ...
              gap: 10,
              padding: "6px 8px",
              background: r.you ? `${accent}14` : "transparent",
              borderRadius: 3,
            }}
          >
            <div
              style={{
                ...
                fontWeight: 800,
                fontSize: 13,
                color: r.rank === 1 ? "#fbbf24" : "rgba(255,255,255,.5)",
              }}
            >
              {r.rank}
            </div>
            <div
              style={{
                ...
                fontSize: 13,
                fontWeight: 700,
                color: r.you ? "#fff" : "rgba(255,255,255,.8)",
              }}
            >
              {r.name}
              {r.you && (
            ...
            <div style={{ fontFamily: "monospace", fontSize: 13, fontWeight: 800, color: accent }}>
              {r.pts}
            </div>
          </div>
        ))}
        ...
        <div style={{ padding: 20 }}>
          ...
          <div
            style={{
              ...
              lineHeight: 1.6,
              marginBottom: step.bullets ? 10 : 18,
            }}
          >
            {step.body}
          </div>
          {step.bullets && (
            <div style={{ display: "flex", flexDirection: "column", gap: 6, marginBottom: 18 }}>
              {step.bullets.map((b, k) => (
                <div
                  key={k}
                  style={{ display: "flex", gap: 8, fontSize: 12, color: "rgba(255,255,255,.75)" }}
                >
              ...
              {STEPS.map((_, k) => (
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    cursor: "pointer",
                    background: k === i ? accent : "rgba(255,255,255,.2)",
                    transition: "width .2s",
                  }}
                />
              ))}
              ...
              {!last ? (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 3,
                    border: `1px solid ${accent}`,
                    background: `linear-gradient(135deg, ${accent}, #ff9a40)`,
                    color: "#1a0e04",
                    fontSize: 12,
                    fontWeight: 800,
                    letterSpacing: 0.5,
