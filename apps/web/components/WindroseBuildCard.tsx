...
export default function WindroseBuildCard({
  ...
  const aspect = build.primaryWidth && build.primaryHeight
    ? build.primaryWidth / build.primaryHeight
    : 4 / 3;
    ...
    >
        ...
        {build.featured && (
          <span
            ...
            style={{
              ...
              fontSize: 12, fontWeight: 900, color: "rgba(232,196,138,.95)",
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: author.avatar ? "rgba(255,255,255,.08)" : (author.avatarColor || "rgba(201,160,102,.4)"),
          display: "flex", alignItems: "center", justifyContent: "center",
          fontSize: 9, fontWeight: 800, color: "#fff",
          overflow: "hidden",
          border: "1px solid rgba(201,160,102,.45)",
        }}>
          {author.avatar ? <img src={author.avatar} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} /> : initial}
        </div>
        <span style={{
          flex: 1, minWidth: 0,
        ...
        {build.buildType && (
          <span style={{
            ...
            flexShrink: 0,
          }}>{TYPE_LABEL[build.buildType] || build.buildType}</span>
        )}
        ...
        <span style={{
          ...
          <svg width="9" height="9" viewBox="0 0 12 12" fill="currentColor"><path d="M6 1 L11 7 L8 7 L8 11 L4 11 L4 7 L1 7 Z" /></svg>
          {score}
        </span>
      </div>
    </button>
