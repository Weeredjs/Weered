  ...
  return (
    <div style={{ marginTop: 20, padding: 12, borderRadius: 12, background: '#fff', boxShadow: '0 8px 24px rgba(0,0,0,0.12)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        {members.map((m) => (
          <div key={m.id} style={{ display: 'flex', gap: 10, padding: 10, borderBottom: '1px solid var(--weered-border)' }}>
      ...
      <div style={{ marginTop: 16, paddingTop: 12, borderTop: '1px solid var(--weered-border)', borderBottom: '1px solid var(--weered-border)' }}>
        ...
        {bans.length === 0 ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {bans.map((b) => (
              <div key={b.userId} style={{ display: 'flex', gap: 10, padding: 10, borderBottom: '1px solid var(--weered-border)' }}>
