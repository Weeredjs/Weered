                ...
                >
                  {dmLoading ? (
                    ...
                    dmActive.msgs.map((m, i, arr) => {
                      ...
                      const isLastSent =
                        isMe && (!nextMsg || nextMsg.fromId !== String(me?.id || ""));
                      return (
                        <React.Fragment key={m.id}>
                          ...
                          {(() => {
                            ...
                            const editable =
                              isMe && !isDeleted && Date.now() - createdTs < 15 * 60 * 1000;
                            ...
                            return (
                              <div
                                ...
                                onMouseLeave={() =>
                                  setDmHoveredMsgId((cur) => (cur === m.id ? "" : cur))
                                }
                                data-msg-id={m.id}
                                style={{
                                  display: "flex",
                              ...
                              >
                                ...
                                {showTime && (
                                  ...
                                  >
                                    ...
                                    {isLastSent && !isDeleted && !m.readAt && (
                                      <span style={{ fontSize: 9, color: "var(--weered-muted)" }}>
                                        Sent
                                      </span>
                                    )}
                                  </div>
