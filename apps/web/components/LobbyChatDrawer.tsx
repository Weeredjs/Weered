    ...
    <>
      <style>{`
        ...
        @keyframes tabPulse {
          ...
          50%       { box-shadow: 0 0 12px 2px ${acDim}; }
        }
        .lobby-chat-drawer {
          position: absolute;
          top: 0;
      ...
      {mounted && (
        <div
          className={`lobby-chat-tab${open ? " open" : ""}`}
          onClick={() => setOpen(o => !o)}
      ...
      {/* Drawer panel */}
      {mounted && open && (
        <div className="lobby-chat-drawer entering">
